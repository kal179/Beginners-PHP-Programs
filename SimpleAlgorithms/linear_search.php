<?php 
	...
	/*
		...
		Arguably this is the most easiest/simplest algorithm out there for searching.
	...
	*/
	...
	$test=findIndexSearch($testCase, -3.141509);
	echo "Algorithm result : ".$test, "\n";        // As always change \n to <br/> if using browser
	echo "Expected Results : ".array_search(3.141509, $testCase), "\n";    
?>
